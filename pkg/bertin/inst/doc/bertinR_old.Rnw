...
%$Id: bertinR.Rnw 67 2012-05-15 11:57:56Z gsawitzki $
%$Author: gsawitzki $
...
\emph{Typeset}, with minor revisions: \today\  from SVN $Revision: 67 $}  
...
oldpar <- par(mfrow=c(3,1)) 
	...
	colramp(RGBinterpolate(n=100,"green","red", igamma=2.0))
par(oldpar)
@
...
Igamma 0.5, linear and spline interpolation, rgb space and Lab space.
\bigskip

<<fig=TRUE, width=6, height=4, label=colorRampPvar05>>=
oldpar <- par(mfrow=c(4,1), mar=c(2, 1, 2, 1) + 0.1)
mycolors <- c("red", "magenta", "blue")
colramp(colorRampPalette(mycolors, space="rgb", interpolate="linear", igamma=0.5)(100))
colramp(colorRampPalette(mycolors, space="Lab", interpolate="linear", igamma=0.5)(100))
colramp(colorRampPalette(mycolors, space="rgb", interpolate="spline", igamma=0.5)(100))
colramp(colorRampPalette(mycolors, space="Lab", interpolate="spline", igamma=0.5)(100))
par(oldpar)
@
\vspace{\stretch{1}}

\clearpage
Igamma 1.0, linear and spline interpolation, rgb space and Lab space.
\bigskip
...
\clearpage
Igamma 2, linear and spline interpolation, rgb space and Lab space.
\bigskip

<<fig=TRUE, width=6, height=4,  label=colorRampPvar20>>=
oldpar <- par(mfrow=c(4,1), mar=c(2, 1, 2, 1) + 0.1)
mycolors <- c("red", "magenta", "blue")
colramp(colorRampPalette(mycolors, space="rgb", interpolate="linear", igammaI=2)(100))
colramp(colorRampPalette(mycolors, space="Lab", interpolate="linear", igammaI=2)(100))
colramp(colorRampPalette(mycolors, space="rgb", interpolate="spline", igammaI=2)(100))
colramp(colorRampPalette(mycolors, space="Lab", interpolate="spline", igammaI=2)(100))
par(oldpar)
@
\vspace{\stretch{1}}
...
\verb#$Id: bertinR.Rnw 67 2012-05-15 11:57:56Z gsawitzki $#\\
\verb#$Revision: 67 $#\\
\verb#$Date: 2012-05-15 13:57:56 +0200 (Tue, 15 May 2012) $#\\
