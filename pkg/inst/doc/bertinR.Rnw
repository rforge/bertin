...
plot.bertin(Hotel2, roworder=rowperm,
	...
	palette=c("white","black"), main="Hotel (repeated)")
...
The highlight features of the  display give a clear picture of a rather homogeneous upper and homogeneous lower group of judges. All criteria seem to say the same. For a small intermediate group, the variables seem to fall into two or three groups. 
